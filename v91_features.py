# -*- coding: utf-8 -*-
"""Taxo 9.1 candidate r9.4 — планування персоналу випуску та UI fixes.
...
APP_VERSION = "9.1 candidate r9.4"
...
ABOUT_TEXT = (
    ...
    "9.1 candidate r9.4: аудит помилок введення графіків, актуалізована форма П-5, "
    "фільтри архіву бланків і розширений місячний контроль.\n"
...
def install(core, base_app):
    """Install Taxo 9.1 candidate r9.4 behavior."""

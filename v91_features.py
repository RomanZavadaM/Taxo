# -*- coding: utf-8 -*-
"""Taxo 9.1 candidate r9.9 — планування персоналу випуску та UI fixes.
...
ABOUT_TEXT = (
    ...
    "9.1 candidate r9.9: шляхівки використовують єдиний склад лікаря/механіка "
    "для дати та номера зміни; нічний рейс не підхоплює наступну дату.\n"
...
def install(core, base_app):
    """Install Taxo 9.1 candidate r9.9 behavior."""

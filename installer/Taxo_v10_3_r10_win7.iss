...
AppVerName={#MyAppName} v{#MyAppVersion} (Windows 7 SP1 x64)
...
OutputBaseFilename=Taxo_v10_3_candidate_r10_Setup_Windows7_x64
...
[Files]
Source: "..\dist\Taxo_v10_3_candidate_r10_Windows7_x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

...
class TachographModule:
    ...
    def build(self):
        ...
        self.tree.pack(fill="both",expand=True); self.tree.bind("<<TreeviewSelect>>",lambda e:self.select())
        ...
        self.itree=ttk.Treeview(result_frame,columns=icols,show="headings",height=6)
        ...
        self.itree.pack(fill="both",expand=True,pady=5)
        ttk.Label(
            result_frame,
            text=(

...
Цей розділ є основною точкою входу до **експлуатаційної документації** Taxo. Stable залишається **9.0.1**; поточна перевірочна лінія — **9.1 candidate r9.4** у PR #29.
...
- [Передетапний аудит Taxo 9.1 candidate r9.4](maintenance/AUDIT_v9_1_r9_4.md)

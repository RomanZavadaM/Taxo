...
Цей розділ є основною точкою входу до **експлуатаційної документації** Taxo. Stable залишається **9.0.1**; поточна перевірочна лінія — **9.1 candidate r9.5** у PR #29.
...
- [Поточний аудит Taxo 9.1 candidate r9.5](maintenance/AUDIT_v9_1_r9_5.md)
...
Документація описує stable **Taxo 9.0.1** та зміни поточного перевірочного кандидата **Taxo 9.1 candidate r9.5**. Кандидат не вважається stable до завершення ручної експлуатаційної перевірки.

...
Актуальний перевірочний кандидат: **Taxo 9.1 candidate r9.5** (GitHub Pre-release; stable `main` не змінюється до завершення manual operational gate).
...
- `v9.1-r9.5` — поточний candidate для ручної перевірки;
...
- новий код після r9.5 потребує нового candidate tag/release;

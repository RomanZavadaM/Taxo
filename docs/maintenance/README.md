...
r9.5 виправляє START-пакет після першого ручного gate-сценарію. Після його CI/публікації наступна обов'язкова дія — повторний запуск START і продовження manual operational gate на реальній Windows-базі. До його завершення `main` і stable 9.0.1 не змінюються.

# Taxo — технічний стан: stable 9.0.1 / candidate 9.1 r9.5

Канонічний технічний стан експлуатаційної лінії: **stable 9.0.1**. Поточна гілка перевірки — **Taxo 9.1 candidate r9.5**, PR #29.

## Головний принцип

Stable 9.0.1 лишається точкою відкату. Кандидат r9.5 не зливається в main до завершення ручної експлуатаційної перевірки. Історичні дані користувача не переписуються автоматично заради виправлення старих конфліктів.

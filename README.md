...
У [стабільному релізі Taxo 10.0](https://github.com/RomanZavadaM/Taxo/releases/tag/v10.0) доступні Windows x64 Setup/Portable, macOS ARM64/Intel Portable, `Taxo_v10_0_START.zip` і файл контрольних сум SHA-256. Робочі бази та персональні дані до релізів **не входять**.

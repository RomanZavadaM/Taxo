...
> **Test checkpoint:** [Taxo 10.1-r2](https://github.com/RomanZavadaM/Taxo/releases/tag/v10.1-r2) — UI refresh поверх driver-role fix; не stable.  
...
**Taxo 10.1-r2 — поточний test checkpoint поверх stable 10.0.** Він зберігає виправлення ролі водія з `v10.1-r1` та додає погоджений UI refresh: новий табель із прямими PDF/Excel/П-5/контролем, перероблену картку працівника, live preview підприємства, «Про програму» і F1-довідку.

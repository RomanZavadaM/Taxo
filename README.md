...
Taxo / Driver Worktime є особистим proprietary software product Романа Завади. Репозиторій залишається публічним для прозорості розробки, але код не ліцензований як open source. Деталі: [LICENSE](LICENSE), [COPYRIGHT](COPYRIGHT), [Third-party notices](THIRD_PARTY_NOTICES.md).

Починаючи з 10.2-r9 PDF відкривається зовнішньою системною програмою або браузером; PyMuPDF вилучено з залежностей.

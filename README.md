...
> **Планування лікаря/механіка/диспетчера:** див. розділ «Робота з персоналом» в інструкції. Поточне вікно відкривається через **Сервіс → «Випуск на лінію — зміни персоналу»**. Перегляд структури планування водіїв і решти персоналу відкладено до наступного кодового кроку `10.2-r8`.

...
> **Current prerelease:** Taxo 10.2-r10 — єдиний маршрут планування персоналу; водійський графік лишається спеціалізованим, а оперативний випуск більше не є другим планувальником.  
...
Для перевірки нових функцій готується **Taxo 10.2-r10** як prerelease зі START/source. Виконавчі пакети публікуються лише на запланованих контрольних точках; назви тестових пакетів і внутрішніх папок містять зрозумілу версію/ревізію без commit-хешів.
...
### Taxo 10.2-r10 — контроль Бланків після зміни ТАХО/графіка
